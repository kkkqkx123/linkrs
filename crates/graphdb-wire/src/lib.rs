...
//!
//! Dependency surface is deliberately minimal (`serde` + `serde_json` +
//! `utoipa` schema derives) so the crate stays usable from both sides
//! without dragging in axum/tonic.
