...
use crate::planning::plan::core::nodes::RemoveNode;
...
use crate::planning::plan::core::nodes::traversal::{
...
impl<'a> PlanNodeVisitor for ChildRewriteVisitor<'a> {
    ...
    impl_leaf_node_rewrite!(
        ...
        visit_copy_from => CopyFromNode, CopyFrom,
        visit_copy_to => CopyToNode, CopyTo,
