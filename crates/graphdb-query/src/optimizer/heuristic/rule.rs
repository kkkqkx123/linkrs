...
use crate::optimizer::heuristic::result::{MatchedResult, RewriteResult, TransformResult};
...
/// # Example
/// ```rust
/// use graphdb_query::optimizer::heuristic::context::RewriteContext;
/// use graphdb_query::optimizer::heuristic::pattern::Pattern;
/// use graphdb_query::optimizer::heuristic::result::{RewriteResult, TransformResult};
