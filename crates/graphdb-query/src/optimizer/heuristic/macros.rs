...
/// use graphdb_query::optimizer::heuristic::pattern::Pattern;
///
/// define_rewrite_rule! {
///     name: MyCustomRule,
...
macro_rules! define_rewrite_rule {
    (
        ...
        impl $crate::optimizer::heuristic::rule::RewriteRule for $name {
            fn name(&self) -> &'static str {
                stringify!($name)
            }

            fn pattern(&self) -> $crate::optimizer::heuristic::pattern::Pattern {
                $pattern
            }
            ...
            ) -> $crate::optimizer::heuristic::result::RewriteResult<Option<$crate::optimizer::heuristic::result::TransformResult>> {
...
macro_rules! define_rewrite_pushdown_rule {
    (
        ...
        impl $crate::optimizer::heuristic::rule::RewriteRule for $name {
            ...
            fn pattern(&self) -> $crate::optimizer::heuristic::pattern::Pattern {
                $crate::optimizer::heuristic::pattern::Pattern::new_with_name(stringify!($parent_type))
        ...
        impl $crate::optimizer::heuristic::rule::PushDownRule for $name {
            fn can_push_down(
                &self,
                node: &$crate::planning::plan::PlanNodeEnum,
                target: &$crate::planning::plan::PlanNodeEnum,
            ) -> bool {
                use $crate::planning::plan::PlanNodeEnum;
                matches!(
                    (node, target),
            ...
            fn push_down(
                ...
                ctx: &mut $crate::optimizer::heuristic::context::RewriteContext,
                node: &$crate::planning::plan::PlanNodeEnum,
                _target: &$crate::planning::plan::PlanNodeEnum,
            ) -> $crate::optimizer::heuristic::result::RewriteResult<Option<$crate::optimizer::heuristic::result::TransformResult>> {
...
/// use graphdb_query::optimizer::heuristic::result::TransformResult;
/// use graphdb_query::optimizer::heuristic::rule::RewriteRule;
/// use graphdb_query::planning::plan::core::nodes::base::plan_node_traits::SingleInputNode;
/// use graphdb_query::planning::plan::core::nodes::operation::filter_node::FilterNode;
///
...
macro_rules! define_rewrite_elimination_rule {
    (
        ...
        impl $crate::optimizer::heuristic::rule::RewriteRule for $name {
            ...
            fn pattern(&self) -> $crate::optimizer::heuristic::pattern::Pattern {
                $crate::optimizer::heuristic::pattern::Pattern::new_with_name(stringify!($node_type))
            }
        ...
        impl $crate::optimizer::heuristic::rule::EliminationRule for $name {
            fn can_eliminate(&self, node: &$crate::planning::plan::PlanNodeEnum) -> bool {
                use $crate::planning::plan::PlanNodeEnum;
    ...
    (
        ...
        impl $crate::optimizer::heuristic::rule::RewriteRule for $name {
            ...
            fn apply(
                ...
                let mut result = $crate::optimizer::heuristic::result::TransformResult::new();
                result.erase_curr = true;
...
macro_rules! define_rewrite_merge_rule {
    (
        ...
        impl $crate::optimizer::heuristic::rule::MergeRule for $name {
            fn can_merge(
                &self,
                parent: &$crate::planning::plan::PlanNodeEnum,
                child: &$crate::planning::plan::PlanNodeEnum,
            ) -> bool {
                use $crate::planning::plan::PlanNodeEnum;
                ...
                $(
                    $(
                        registry.add(RewriteRule::$rule_name(
                            $crate::optimizer::heuristic::$category::paste! {[<$rule_name Rule>]}::new()
                        ));
                    )*
                )*
                registry
