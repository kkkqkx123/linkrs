...
pub struct TransformResult {
    ...
    pub new_nodes: Vec<crate::planning::plan::PlanNodeEnum>,
    /// New dependencies
...
impl TransformResult {
    ...
    pub fn add_new_node(&mut self, node: crate::planning::plan::PlanNodeEnum) {
    ...
    pub fn first_new_node(&self) -> Option<&crate::planning::plan::PlanNodeEnum> {
...
pub struct MatchedResult {
    ...
    pub nodes: Vec<crate::planning::plan::PlanNodeEnum>,
    /// List of dependent nodes
    pub dependencies: Vec<crate::planning::plan::PlanNodeEnum>,
    /// Root node
    pub root_node: Option<crate::planning::plan::PlanNodeEnum>,
}
...
impl MatchedResult {
    ...
    /// Add matching nodes
    pub fn add_node(&mut self, node: crate::planning::plan::PlanNodeEnum) {
        self.nodes.push(node);
    }

    /// Add dependency nodes
    pub fn add_dependency(&mut self, node: crate::planning::plan::PlanNodeEnum) {
        self.dependencies.push(node);
    }

    /// Setting the root node
    pub fn set_root_node(&mut self, node: crate::planning::plan::PlanNodeEnum) {
    ...
    pub fn first_node(&self) -> Option<&crate::planning::plan::PlanNodeEnum> {
        self.nodes.first()
    }

    /// Obtain the first dependent node.
    pub fn first_dependency(&self) -> Option<&crate::planning::plan::PlanNodeEnum> {
...
mod tests {
    ...
    fn test_transform_result() {
        ...
        let node =
            crate::planning::plan::PlanNodeEnum::ScanVertices(ScanVerticesNode::new(1, "default"));
