...
/// # Example
/// ```
/// use graphdb_query::optimizer::stats::feedback::trigger::AutoFeedbackConfig;
///
...
/// # Examples
/// ```
/// use graphdb_query::optimizer::stats::feedback::trigger::{AutoFeedbackTrigger, AutoFeedbackConfig};
///
