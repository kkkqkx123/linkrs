...
//! use graphdb_query::optimizer::cost_based::SortEliminationOptimizer;
...
use crate::planning::plan::core::nodes::{SortItem, SortNode};
...
mod tests {
    ...
    fn test_context_creation() {
        ...
        let sort_node = SortNode::new(
            crate::planning::plan::PlanNodeEnum::Start(start_node),
