...
use crate::optimizer::cost::selectivity::SelectivityEstimator;
    ...
    fn estimate(
        ...
        match node {
            PlanNodeEnum::Filter(n) => {
                ...
                let selectivity = self.selectivity_estimator.estimate_from_expression(
                    stats.space(),
                    &condition_expr,
                    None,
                );
...
mod tests {
    ...
    fn test_count_filter_conditions_simple() {
        ...
        let condition = Expression::Binary {
            ...
            right: Box::new(Expression::Literal(Value::string("1"))),
        };
