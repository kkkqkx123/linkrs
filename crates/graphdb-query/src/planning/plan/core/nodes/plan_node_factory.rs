...
impl PlanNodeFactory {
    ...
    pub fn create_minus(
        ...
        use crate::planning::plan::core::nodes::graph_operations::set_operations_node::MinusNode;
    ...
    pub fn create_intersect(
        ...
        use crate::planning::plan::core::nodes::graph_operations::set_operations_node::IntersectNode;
