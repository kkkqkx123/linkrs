...
/// use graphdb_query::planning::plan::core::nodes::base::plan_node_category::PlanNodeCategory;
///
...
macro_rules! define_all_plan_nodes {
    ($enum_type:ident, $($(#[$meta:meta])* ($variant:ident, $node_type:ty, $category:expr, $describe:expr)),* $(,)?) => {
        impl $enum_type {
            ...
            pub fn category(&self) -> $crate::planning::plan::core::nodes::base::plan_node_category::PlanNodeCategory {
            ...
            pub fn describe(&self) -> $crate::planning::plan::explain::PlanNodeDescription {
                use $crate::planning::plan::explain::PlanNodeDescription;
                match self {
