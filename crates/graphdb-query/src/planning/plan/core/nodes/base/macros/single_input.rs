...
macro_rules! define_plan_node {
    ...
    (
        ...
        impl $crate::planning::plan::core::nodes::base::plan_node_traits::PlanNode for $name {
            ...
            fn category(&self) -> $crate::planning::plan::core::nodes::base::plan_node_category::PlanNodeCategory {
                $crate::planning::plan::core::nodes::base::plan_node_category::PlanNodeCategory::Access
            }
        ...
        impl $crate::planning::plan::core::nodes::base::plan_node_traits::ZeroInputNode for $name {}
    ...
    (
        ...
        impl $name {
            ...
            pub fn clone_plan_node(&self) -> $crate::planning::plan::core::nodes::base::plan_node_enum::PlanNodeEnum {
                use $crate::planning::plan::core::nodes::base::plan_node_enum::PlanNodeEnum;
                use $crate::planning::plan::core::nodes::management::manage_node_enums::$category;
    ...
    (
        ...
        impl $crate::planning::plan::core::nodes::base::plan_node_traits::MultipleInputNode for $name {
            fn inputs(&self) -> &[$crate::planning::plan::core::nodes::base::plan_node_enum::PlanNodeEnum] {
                &self.deps
            }

            fn inputs_mut(&mut self) -> &mut Vec<$crate::planning::plan::core::nodes::base::plan_node_enum::PlanNodeEnum> {
                &mut self.deps
            }

            fn add_input(&mut self, input: $crate::planning::plan::core::nodes::base::plan_node_enum::PlanNodeEnum) {
