...
macro_rules! define_logical_plan_node {
    (
        ...
        impl $crate::planning::plan::logical::logical_node_traits::LogicalNode for $name {
            ...
            fn into_enum(self) -> $crate::planning::plan::logical::logical_node_enum::LogicalNodeEnum {
                use $crate::planning::plan::logical::logical_node_enum::LogicalNodeEnum;
                LogicalNodeEnum::$enum_variant(self)
            }
        }

        impl $crate::planning::plan::logical::logical_node_traits::LogicalZeroInputNode for $name {}
    };
    ...
    (
        ...
        impl $name {
            ...
            pub fn add_dependency(&mut self, dep: $crate::planning::plan::logical::logical_node_enum::LogicalNodeEnum) {
                self.deps.push(dep);
            }
        ...
        impl $crate::planning::plan::logical::logical_node_traits::LogicalMultipleInputNode for $name {
            fn inputs(&self) -> &[$crate::planning::plan::logical::logical_node_enum::LogicalNodeEnum] {
                &self.deps
            }

            fn inputs_mut(&mut self) -> &mut Vec<$crate::planning::plan::logical::logical_node_enum::LogicalNodeEnum> {
                &mut self.deps
            }

            fn add_input(&mut self, input: $crate::planning::plan::logical::logical_node_enum::LogicalNodeEnum) {
...
macro_rules! define_logical_plan_node_with_deps {
    (
        ...
        impl $crate::planning::plan::logical::logical_node_traits::LogicalSingleInputNode for $name {
            fn input(&self) -> &$crate::planning::plan::logical::logical_node_enum::LogicalNodeEnum {
                self.input.as_ref().expect("Input node does not exist")
            }

            fn input_mut(&mut self) -> &mut $crate::planning::plan::logical::logical_node_enum::LogicalNodeEnum {
...
macro_rules! define_logical_join_node {
    (
        ...
        impl $name {
            ...
            pub fn right_input(&self) -> &$crate::planning::plan::logical::logical_node_enum::LogicalNodeEnum {
                &self.right
            }

            pub fn left_input_mut(&mut self) -> &mut $crate::planning::plan::logical::logical_node_enum::LogicalNodeEnum {
                &mut self.left
            }

            pub fn right_input_mut(&mut self) -> &mut $crate::planning::plan::logical::logical_node_enum::LogicalNodeEnum {
                &mut self.right
            }
        ...
        impl $crate::planning::plan::logical::logical_node_traits::LogicalBinaryInputNode for $name {
            fn left_input(&self) -> &$crate::planning::plan::logical::logical_node_enum::LogicalNodeEnum {
                &self.left
            }

            fn right_input(&self) -> &$crate::planning::plan::logical::logical_node_enum::LogicalNodeEnum {
                &self.right
            }

            fn left_input_mut(&mut self) -> &mut $crate::planning::plan::logical::logical_node_enum::LogicalNodeEnum {
                &mut self.left
            }

            fn right_input_mut(&mut self) -> &mut $crate::planning::plan::logical::logical_node_enum::LogicalNodeEnum {
                &mut self.right
            }
