        ...
        let (insert_node, created_count) = match &create_stmt.target {
            ...
            CreateTarget::Path { patterns } => {
                ...
                for pattern in patterns {
                    match pattern {
                        crate::parser::ast::pattern::Pattern::Path(path) => {
                        ...
                        crate::parser::ast::pattern::Pattern::Node(node) => {
...
impl CreatePlanner {
    ...
    fn process_node_pattern(
        &self,
        node: &crate::parser::ast::pattern::NodePattern,
        space_name: &str,
        expr_context: &Arc<ExpressionAnalysisContext>,
    ) -> Result<VertexInsertInfo, PlannerError> {
    ...
    fn process_path_pattern(
        &self,
        path: &crate::parser::ast::pattern::PathPattern,
        space_name: &str,
        expr_context: &Arc<ExpressionAnalysisContext>,
        ...
        for element in &path.elements {
            match element {
                crate::parser::ast::pattern::PathElement::Node(node) => {
                ...
                crate::parser::ast::pattern::PathElement::Edge(edge) => {
