...
use crate::planning::plan::core::nodes::graph_operations::graph_operations_node::DedupNode;
...
use crate::planning::plan::core::nodes::AggregateNode;
...
fn expression_contains_aggregate(expr: &graphdb_core::Expression) -> bool {
    ...
    match expr {
        ...
        Expression::Function { args, .. } => args
            .iter()
            .any(|a| expression_contains_aggregate(a.as_expr())),
        _ => false,
    }
}
...
fn expression_contains_window_function(expr: &graphdb_core::Expression) -> bool {
    ...
    match expr {
        ...
        Expression::Function { args, .. } => args
            .iter()
            .any(|a| expression_contains_window_function(a.as_expr())),
        _ => false,
    }
}
...
fn extract_aggregate_function(
    ...
    match expr {
        ...
        Expression::Function { args, .. } => args
            .iter()
            .find_map(|a| extract_aggregate_function(a.as_expr())),
        _ => None,
    }
}
...
mod tests {
    ...
    fn test_extract_distinct_flag() {
        let match_stmt = Stmt::Match(crate::parser::ast::stmt::MatchStmt {
            ...
            patterns: vec![],
            where_clause: None,
            return_clause: Some(crate::parser::ast::stmt::ReturnClause {
                span: Span::default(),
                items: vec![],
                distinct: true,
                order_by: None,
    ...
    fn test_extract_return_columns() {
        ...
        let match_stmt = Stmt::Match(crate::parser::ast::stmt::MatchStmt {
            ...
            return_clause: Some(crate::parser::ast::stmt::ReturnClause {
                span: Span::default(),
                items: vec![crate::parser::ast::stmt::ReturnItem::Expression {
