...
impl YieldClausePlanner {
    ...
    pub fn plan_yield_clause(
        ...
        if let Some(sample_count) = sample {
            ...
            let sample_node =
                SampleNode::new(input_node.clone(), sample_count as i64).map_err(|e| {
...
mod tests {
    ...
    fn test_extract_yield_info_from_go_stmt() {
        ...
        let go_stmt = Stmt::Go(crate::parser::ast::stmt::GoStmt {
            span: Span::default(),
            steps: crate::parser::ast::Steps::Fixed(1),
            from: crate::parser::ast::stmt::FromClause {
                span: Span::default(),
                vertices: vec![],
            },
            over: None,
            ...
            yield_clause: Some(crate::parser::ast::stmt::YieldClause {
                ...
                where_clause: None,
                order_by: None,
                limit: Some(crate::parser::ast::types::LimitClause {
                    span: Span::default(),
                    count: 10,
                }),
                skip: Some(crate::parser::ast::types::SkipClause {
                    span: Span::default(),
                    count: 5,
                }),
                sample: None,
    ...
    fn test_convert_yield_items() {
        ...
        let items = vec![crate::parser::ast::stmt::YieldItem {
            expression: ctx_expr.clone(),
