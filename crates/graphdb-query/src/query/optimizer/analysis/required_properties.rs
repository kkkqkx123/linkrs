...
fn single_tag(tag_props: &[crate::query::planning::plan::core::common::TagProp]) -> Option<String> {
...
mod tests {
    ...
    fn test_analyzer_matches_binding_variable() {
        ...
        let join = crate::query::planning::plan::core::nodes::join::InnerJoinNode::new(
            left,
            right,
            vec![],
            vec![],
    ...
    fn test_analyzer_tag_resolution() {
        ...
        node.set_tag_props(vec![crate::query::planning::plan::core::common::TagProp {
