...
use crate::query::optimizer::analysis::RequiredPropertyAnalyzer;
    ...
    fn apply(
        ...
        let vertex_props: Vec<_> = append_node
            ...
            .map(|tp| {
                ...
                crate::query::planning::plan::core::common::TagProp {
                    tag: tp.tag.clone(),
                    props: kept,
                }
            })
...
impl crate::query::optimizer::heuristic::rule::PushDownRule for PushProjectDownAppendVerticesRule {
