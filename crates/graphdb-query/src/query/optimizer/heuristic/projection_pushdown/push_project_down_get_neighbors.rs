...
use crate::query::optimizer::analysis::{binding_var, RequiredPropertyAnalyzer};
...
impl crate::query::optimizer::heuristic::rule::PushDownRule for PushProjectDownGetNeighborsRule {
