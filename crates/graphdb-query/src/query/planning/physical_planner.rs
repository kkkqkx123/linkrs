...
pub(crate) fn convert_logical_to_physical(logical: LogicalNodeEnum) -> PlanNodeEnum {
    match logical {
        ...
        LogicalNodeEnum::GetVertices(n) => {
            let deps: Vec<PlanNodeEnum> = n.deps.into_iter().map(convert_logical_to_physical).collect();
            let mut node = crate::query::planning::plan::core::nodes::access::graph_scan_node::GetVerticesNode::new(n.space_id, &n.space_name, &n.src_vids);
            node.set_deps(deps);
        ...
        LogicalNodeEnum::GetNeighbors(n) => {
            let deps: Vec<PlanNodeEnum> = n.deps.into_iter().map(convert_logical_to_physical).collect();
            let mut node = crate::query::planning::plan::core::nodes::access::graph_scan_node::GetNeighborsNode::new(n.space_id, &n.src_vids);
            node.set_deps(deps);
        ...
        LogicalNodeEnum::ScanVertices(n) => {
            let mut node = crate::query::planning::plan::core::nodes::access::graph_scan_node::ScanVerticesNode::new(n.space_id, &n.space_name);
        ...
        LogicalNodeEnum::ScanEdges(n) => {
            ...
            let mut node = crate::query::planning::plan::core::nodes::access::graph_scan_node::ScanEdgesNode::new(n.space_id, &edge_type);
            if let Some(expr) = n.expression {
        ...
        LogicalNodeEnum::Project(n) => {
            ...
            let mut node = crate::query::planning::plan::core::nodes::operation::project_node::ProjectNode::new(
                input, n.columns,
        ...
        LogicalNodeEnum::Filter(n) => {
            ...
            let mut node = crate::query::planning::plan::core::nodes::operation::filter_node::FilterNode::new(
                input, n.condition,
        ...
        LogicalNodeEnum::Sort(n) => {
            ...
            let mut node = crate::query::planning::plan::core::nodes::operation::sort_node::SortNode::new(
                input, n.sort_items,
        ...
        LogicalNodeEnum::Limit(n) => {
            ...
            let mut node = crate::query::planning::plan::core::nodes::operation::sort_node::LimitNode::new(
        ...
        LogicalNodeEnum::TopN(n) => {
            ...
            let mut node = crate::query::planning::plan::core::nodes::operation::sort_node::TopNNode::new(
                input, n.sort_items, n.limit,
        ...
        LogicalNodeEnum::Sample(n) => {
            ...
            let mut node = crate::query::planning::plan::core::nodes::operation::sample_node::SampleNode::new(
                input, n.count,
        ...
        LogicalNodeEnum::Dedup(n) => {
            ...
            let mut node = match crate::query::planning::plan::core::nodes::graph_operations::graph_operations_node::DedupNode::new(input) {
                Ok(n) => n,
        ...
        LogicalNodeEnum::Aggregate(n) => {
            ...
            let mut node = crate::query::planning::plan::core::nodes::graph_operations::aggregate_node::AggregateNode::new(
        ...
        LogicalNodeEnum::Window(n) => {
            ...
            let mut node = crate::query::planning::plan::core::nodes::graph_operations::window_node::WindowNode::new(
        ...
        LogicalNodeEnum::InnerJoin(n) => {
            ...
            if hash_keys.is_empty() {
                let mut node = crate::query::planning::plan::core::nodes::join::join_node::InnerJoinNode::new(
        ...
        LogicalNodeEnum::LeftJoin(n) => {
            ...
            let probe_keys = n.probe_keys;
            if hash_keys.is_empty() {
                let mut node = crate::query::planning::plan::core::nodes::join::join_node::LeftJoinNode::new(
                    left, right, hash_keys, probe_keys,
        ...
        LogicalNodeEnum::RightJoin(n) => {
            let left = convert_logical_to_physical(*n.left);
            let right = convert_logical_to_physical(*n.right);
            let mut node = crate::query::planning::plan::core::nodes::join::join_node::RightJoinNode::new(
                left, right, n.hash_keys, n.probe_keys,
        ...
        LogicalNodeEnum::CrossJoin(n) => {
            let left = convert_logical_to_physical(*n.left);
            let right = convert_logical_to_physical(*n.right);
            let mut node = crate::query::planning::plan::core::nodes::join::join_node::CrossJoinNode::new(
                left, right,
        ...
        LogicalNodeEnum::FullOuterJoin(n) => {
            let left = convert_logical_to_physical(*n.left);
            let right = convert_logical_to_physical(*n.right);
            let mut node = crate::query::planning::plan::core::nodes::join::join_node::FullOuterJoinNode::new(
                left, right, n.hash_keys, n.probe_keys,
        ...
        LogicalNodeEnum::SemiJoin(n) => {
            let left = convert_logical_to_physical(*n.left);
            let right = convert_logical_to_physical(*n.right);
            let mut node = crate::query::planning::plan::core::nodes::join::join_node::SemiJoinNode::new(
                left, right, n.hash_keys, n.probe_keys, false,
        ...
        LogicalNodeEnum::Expand(n) => {
            let deps: Vec<PlanNodeEnum> = n.deps.into_iter().map(convert_logical_to_physical).collect();
            let mut node = crate::query::planning::plan::core::nodes::traversal::traversal_node::ExpandNode::new(
        ...
        LogicalNodeEnum::ExpandAll(n) => {
            let deps: Vec<PlanNodeEnum> = n.deps.into_iter().map(convert_logical_to_physical).collect();
            let mut node = crate::query::planning::plan::core::nodes::traversal::traversal_node::ExpandAllNode::new(
                n.space_id, n.edge_types, &n.direction,
            );
        ...
        LogicalNodeEnum::Traverse(n) => {
            ...
            let mut node = crate::query::planning::plan::core::nodes::traversal::traversal_node::TraverseNode::new(
        ...
        LogicalNodeEnum::AppendVertices(n) => {
            let deps: Vec<PlanNodeEnum> = n.deps.into_iter().map(convert_logical_to_physical).collect();
            let mut node = crate::query::planning::plan::core::nodes::traversal::traversal_node::AppendVerticesNode::new(
        ...
        LogicalNodeEnum::BiExpand(n) => {
            let left = convert_logical_to_physical(*n.left);
            let right = convert_logical_to_physical(*n.right);
            let mut node = crate::query::planning::plan::core::nodes::traversal::traversal_node::BiExpandNode::new(
        ...
        LogicalNodeEnum::BiTraverse(n) => {
            let left = convert_logical_to_physical(*n.left);
            let right = convert_logical_to_physical(*n.right);
            use crate::query::planning::plan::core::nodes::traversal::traversal_node::BiTraverseNodeParams;
            ...
            let mut node = crate::query::planning::plan::core::nodes::traversal::traversal_node::BiTraverseNode::new(params);
        ...
        LogicalNodeEnum::Argument(n) => {
            let mut node = crate::query::planning::plan::core::nodes::control_flow::control_flow_node::ArgumentNode::new(next_node_id(), &n.var);
            if let Some(var) = n.output_var {
                node.set_output_var(var);
            }
            node.set_col_names(n.col_names);
        ...
        LogicalNodeEnum::Loop(n) => {
            ...
            let mut node = crate::query::planning::plan::core::nodes::control_flow::control_flow_node::LoopNode::new(
        ...
        LogicalNodeEnum::PassThrough(n) => {
            let mut node = crate::query::planning::plan::core::nodes::control_flow::control_flow_node::PassThroughNode::new(next_node_id());
            if let Some(var) = n.output_var {
                node.set_output_var(var);
            }
            node.set_col_names(n.col_names);
        ...
        LogicalNodeEnum::Select(n) => {
            let mut node = crate::query::planning::plan::core::nodes::control_flow::control_flow_node::SelectNode::new(
                next_node_id(), n.condition().clone(),
            );
        ...
        LogicalNodeEnum::BeginTransaction(n) => {
            let mut node = crate::query::planning::plan::core::nodes::control_flow::control_flow_node::BeginTransactionNode::new(next_node_id());
            if let Some(var) = n.output_var {
                node.set_output_var(var);
            }
            node.set_col_names(n.col_names);
        ...
        LogicalNodeEnum::Commit(n) => {
            let mut node = crate::query::planning::plan::core::nodes::control_flow::control_flow_node::CommitNode::new(next_node_id());
            if let Some(var) = n.output_var {
                node.set_output_var(var);
            }
            node.set_col_names(n.col_names);
        ...
        LogicalNodeEnum::Rollback(n) => {
            let mut node = crate::query::planning::plan::core::nodes::control_flow::control_flow_node::RollbackNode::new(next_node_id());
            if let Some(var) = n.output_var {
                node.set_output_var(var);
            }
            node.set_col_names(n.col_names);
        ...
        LogicalNodeEnum::DataCollect(n) => {
            ...
            let mut node = crate::query::planning::plan::core::nodes::graph_operations::graph_operations_node::DataCollectNode::new(
        ...
        LogicalNodeEnum::Remove(n) => {
            ...
            let mut node = crate::query::planning::plan::core::nodes::graph_operations::graph_operations_node::RemoveNode::new(
        ...
        LogicalNodeEnum::PatternApply(n) => {
            let input = convert_logical_to_physical(*n.input.expect("PatternApplyNode missing input"));
        ...
        LogicalNodeEnum::RollUpApply(n) => {
            ...
            let fallback = crate::query::planning::plan::core::nodes::control_flow::start_node::StartNode::new().into_enum();
            let mut node = crate::query::planning::plan::core::nodes::graph_operations::graph_operations_node::RollUpApplyNode::new(
        ...
        LogicalNodeEnum::Union(n) => {
            ...
            let mut node = crate::query::planning::plan::core::nodes::graph_operations::graph_operations_node::UnionNode::new(
        ...
        LogicalNodeEnum::Minus(n) => {
            ...
            let mut node = crate::query::planning::plan::core::nodes::graph_operations::set_operations_node::MinusNode::new(
                input, minus_input,
        ...
        LogicalNodeEnum::Intersect(n) => {
            ...
            let mut node = crate::query::planning::plan::core::nodes::graph_operations::set_operations_node::IntersectNode::new(
        ...
        LogicalNodeEnum::Unwind(n) => {
            ...
            let mut node = crate::query::planning::plan::core::nodes::graph_operations::graph_operations_node::UnwindNode::new(
        ...
        LogicalNodeEnum::Materialize(n) => {
            ...
            let mut node = crate::query::planning::plan::core::nodes::graph_operations::graph_operations_node::MaterializeNode::new(
                input,
        ...
        LogicalNodeEnum::Assign(n) => {
            ...
            let mut node = crate::query::planning::plan::core::nodes::graph_operations::graph_operations_node::AssignNode::new(
                input, n.assignments,
        ...
        LogicalNodeEnum::Apply(n) => {
            ...
            let mut node = crate::query::planning::plan::core::nodes::graph_operations::graph_operations_node::ApplyNode::new(
        ...
        LogicalNodeEnum::MultiShortestPath(n) => {
            let left = convert_logical_to_physical(*n.left);
            let right = convert_logical_to_physical(*n.right);
            let mut node = crate::query::planning::plan::core::nodes::traversal::path_algorithms::MultiShortestPathNode::new(
                left, right, n.steps,
            );
        ...
        LogicalNodeEnum::BFSShortest(n) => {
            let left = convert_logical_to_physical(*n.left);
            let right = convert_logical_to_physical(*n.right);
            let mut node = crate::query::planning::plan::core::nodes::traversal::path_algorithms::BFSShortestNode::new(
        ...
        LogicalNodeEnum::AllPaths(n) => {
            let left = convert_logical_to_physical(*n.left);
            let right = convert_logical_to_physical(*n.right);
            let mut node = crate::query::planning::plan::core::nodes::traversal::path_algorithms::AllPathsNode::new(
        ...
        LogicalNodeEnum::ShortestPath(n) => {
            let left = convert_logical_to_physical(*n.left);
            let right = convert_logical_to_physical(*n.right);
            let mut node = crate::query::planning::plan::core::nodes::traversal::path_algorithms::ShortestPathNode::new(
        ...
        LogicalNodeEnum::FulltextSearch(n) => {
            let mut node = crate::query::planning::plan::core::nodes::search::fulltext::data_access::FulltextSearchNode::new(
        ...
        LogicalNodeEnum::FulltextLookup(n) => {
            let mut node = crate::query::planning::plan::core::nodes::search::fulltext::data_access::FulltextLookupNode::new(
        ...
        LogicalNodeEnum::MatchFulltext(n) => {
            let mut node = crate::query::planning::plan::core::nodes::search::fulltext::data_access::MatchFulltextNode::new(
