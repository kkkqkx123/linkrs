...
impl crate::query::planning::plan::logical::logical_node_traits::LogicalNode for LogicalApplyNode {
    fn id(&self) -> i64 {
        self.id()
    }
...
impl crate::query::planning::plan::logical::logical_node_traits::LogicalBinaryInputNode
