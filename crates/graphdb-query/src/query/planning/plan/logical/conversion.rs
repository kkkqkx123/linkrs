...
pub fn convert_plan(node: &PlanNodeEnum) -> Result<LogicalNodeEnum, ConversionError> {
    match node {
        ...
        PlanNodeEnum::Start(n) => Ok(LogicalNodeEnum::Start(
            crate::query::planning::plan::logical::logical_nodes::access::LogicalStartNode {
                id: n.id(),
        ...
        PlanNodeEnum::ScanVertices(n) => Ok(LogicalNodeEnum::ScanVertices(
            crate::query::planning::plan::logical::logical_nodes::access::LogicalScanVerticesNode {
                ...
                tag: n.tag().cloned(),
                expression: n.vertex_filter().cloned(),
                limit: n.limit(),
        ...
        PlanNodeEnum::Project(n) => {
            ...
            Ok(LogicalNodeEnum::Project(
                crate::query::planning::plan::logical::logical_nodes::operation::LogicalProjectNode {
                    id: n.id(),
        ...
        PlanNodeEnum::Filter(n) => {
            ...
            Ok(LogicalNodeEnum::Filter(
                crate::query::planning::plan::logical::logical_nodes::operation::LogicalFilterNode {
                    id: n.id(),
                    input: Some(Box::new(logical_input.clone())),
                    deps: vec![logical_input],
        ...
        PlanNodeEnum::Sort(n) => {
            ...
            Ok(LogicalNodeEnum::Sort(
                crate::query::planning::plan::logical::logical_nodes::operation::LogicalSortNode {
                    id: n.id(),
                    input: Some(Box::new(logical_input.clone())),
                    deps: vec![logical_input],
        ...
        PlanNodeEnum::Limit(n) => {
            ...
            Ok(LogicalNodeEnum::Limit(
                crate::query::planning::plan::logical::logical_nodes::operation::LogicalLimitNode {
                    id: n.id(),
                    input: Some(Box::new(logical_input.clone())),
                    deps: vec![logical_input],
                    offset: n.offset(),
        ...
        PlanNodeEnum::TopN(n) => {
            ...
            Ok(LogicalNodeEnum::TopN(
                crate::query::planning::plan::logical::logical_nodes::operation::LogicalTopNNode {
                    id: n.id(),
                    input: Some(Box::new(logical_input.clone())),
                    deps: vec![logical_input],
                    sort_items: n.sort_items().to_vec(),
        ...
        PlanNodeEnum::Sample(n) => {
            ...
            Ok(LogicalNodeEnum::Sample(
                crate::query::planning::plan::logical::logical_nodes::operation::LogicalSampleNode {
                    id: n.id(),
                    input: Some(Box::new(logical_input.clone())),
                    deps: vec![logical_input],
                    count: n.count(),
        ...
        PlanNodeEnum::Dedup(n) => {
            ...
            Ok(LogicalNodeEnum::Dedup(
                crate::query::planning::plan::logical::logical_nodes::operation::LogicalDedupNode {
                    id: n.id(),
                    input: Some(Box::new(logical_input.clone())),
                    deps: vec![logical_input],
                    output_var: n.output_var().map(|s| s.to_string()),
        ...
        PlanNodeEnum::Aggregate(n) => {
            ...
            Ok(LogicalNodeEnum::Aggregate(
                crate::query::planning::plan::logical::logical_nodes::operation::LogicalAggregateNode {
                    id: n.id(),
                    input: Some(Box::new(logical_input.clone())),
                    deps: vec![logical_input],
        ...
        PlanNodeEnum::Window(n) => {
            ...
            Ok(LogicalNodeEnum::Window(
                crate::query::planning::plan::logical::logical_nodes::operation::LogicalWindowNode {
                    id: n.id(),
                    input: Some(Box::new(logical_input.clone())),
                    deps: vec![logical_input],
        ...
        PlanNodeEnum::RightJoin(n) => {
            ...
            Ok(LogicalNodeEnum::RightJoin(
                crate::query::planning::plan::logical::logical_nodes::join::LogicalRightJoinNode {
                    id: n.id(),
                    left: Box::new(logical_left.clone()),
                    right: Box::new(logical_right.clone()),
                    hash_keys: n.hash_keys().to_vec(),
        ...
        PlanNodeEnum::CrossJoin(n) => {
            ...
            Ok(LogicalNodeEnum::CrossJoin(
                crate::query::planning::plan::logical::logical_nodes::join::LogicalCrossJoinNode {
                    id: n.id(),
                    left: Box::new(logical_left.clone()),
                    right: Box::new(logical_right.clone()),
                    hash_keys: vec![],
        ...
        PlanNodeEnum::FullOuterJoin(n) => {
            ...
            Ok(LogicalNodeEnum::FullOuterJoin(
                crate::query::planning::plan::logical::logical_nodes::join::LogicalFullOuterJoinNode {
                    id: n.id(),
                    left: Box::new(logical_left.clone()),
                    right: Box::new(logical_right.clone()),
                    hash_keys: n.hash_keys().to_vec(),
        ...
        PlanNodeEnum::SemiJoin(n) => {
            ...
            Ok(LogicalNodeEnum::SemiJoin(
                crate::query::planning::plan::logical::logical_nodes::join::LogicalSemiJoinNode {
                    id: n.id(),
                    left: Box::new(logical_left.clone()),
                    right: Box::new(logical_right.clone()),
                    hash_keys: n.hash_keys().to_vec(),
...
mod tests {
    ...
    fn test_convert_unsupported() {
        let arg = crate::query::planning::plan::core::nodes::control_flow::control_flow_node::ArgumentNode::new(-1, "x");
