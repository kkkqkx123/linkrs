...
pub(in crate::query::executor::streaming::plan::arena_builder) fn build_source_spec(
    node: &PlanNodeEnum,
...
pub(in crate::query::executor::streaming::plan::arena_builder) fn build_standalone_write_source(
    node: &PlanNodeEnum,
) -> Result<SourceSpec, PlanBuildError> {
