...
pub struct WorkerPool {
    ...
    /// Mapping from task_id to executor_id (for task execution)
...
impl WorkerPool {
    ...
    /// Create a new worker pool with executor registry (for worker thread execution)
    ...
    pub fn executor_registry(&self) -> Arc<Mutex<HashMap<usize, Box<StreamingExecutor>>>> {
