...
impl<S: StorageClient + Send + 'static> TransformationBuilder<S> {
    ...
    pub fn build_unwind(
        ...
        Ok(ExecutorEnum::ResultProcessing(
            ResultProcessingExecutor::Unwind(executor),
        ))
    }
    ...
    pub fn build_assign(
        ...
        Ok(ExecutorEnum::ResultProcessing(
            ResultProcessingExecutor::Assign(executor),
        ))
    }
    ...
    pub fn build_materialize(
        ...
        Ok(ExecutorEnum::ResultProcessing(
            ResultProcessingExecutor::Materialize(executor),
        ))
    }
    ...
    pub fn build_append_vertices(
        ...
        Ok(ExecutorEnum::ResultProcessing(
            ResultProcessingExecutor::AppendVertices(executor),
        ))
    }
    ...
    pub fn build_rollup_apply(
        ...
        Ok(ExecutorEnum::ResultProcessing(
            ResultProcessingExecutor::RollUpApply(executor),
        ))
    }
    ...
    pub fn build_pattern_apply(
        ...
        Ok(ExecutorEnum::ResultProcessing(
            ResultProcessingExecutor::PatternApply(executor),
        ))
    }
