...
impl<S: StorageClient + Send + 'static> TraversalBuilder<S> {
    ...
    pub fn build_expand(
        ...
        Ok(ExecutorEnum::GraphOperation(
            GraphOperationExecutor::Expand(executor),
        ))
    }
    ...
    pub fn build_expand_all(
        ...
        Ok(ExecutorEnum::GraphOperation(
            GraphOperationExecutor::ExpandAll(executor),
        ))
    }
    ...
    pub fn build_traverse(
        ...
        Ok(ExecutorEnum::GraphOperation(
            GraphOperationExecutor::Traverse(executor),
        ))
    }
    ...
    pub fn build_all_paths(
        ...
        Ok(ExecutorEnum::GraphOperation(
            GraphOperationExecutor::AllPaths(executor),
        ))
    }
    ...
    pub fn build_shortest_path(
        ...
        Ok(ExecutorEnum::GraphOperation(
            GraphOperationExecutor::ShortestPath(executor),
        ))
    }
    ...
    pub fn build_bfs_shortest(
        ...
        Ok(ExecutorEnum::GraphOperation(
            GraphOperationExecutor::BFSShortest(executor),
        ))
    }
    ...
    pub fn build_multi_shortest_path(
        ...
        Ok(ExecutorEnum::GraphOperation(
            GraphOperationExecutor::MultiShortestPath(executor),
        ))
    }
    ...
    pub fn build_bi_expand(
        ...
        Ok(ExecutorEnum::GraphOperation(
            GraphOperationExecutor::BiExpand(executor),
        ))
    }
    ...
    pub fn build_bi_traverse(
        ...
        Ok(ExecutorEnum::GraphOperation(
            GraphOperationExecutor::BiTraverse(executor),
        ))
    }
}
