...
impl<S: StorageClient + Send + 'static> DataProcessingBuilder<S> {
    ...
    pub fn build_limit(
        ...
        Ok(ExecutorEnum::ResultProcessing(
            ResultProcessingExecutor::Limit(executor),
        ))
    }
    ...
    pub fn build_sort(
        ...
        Ok(ExecutorEnum::ResultProcessing(
            ResultProcessingExecutor::Sort(executor),
        ))
    }
    ...
    pub fn build_topn(
        ...
        Ok(ExecutorEnum::ResultProcessing(
            ResultProcessingExecutor::TopN(executor),
        ))
    }
    ...
    pub fn build_sample(
        ...
        Ok(ExecutorEnum::ResultProcessing(
            ResultProcessingExecutor::Sample(executor),
        ))
    }
    ...
    pub fn build_aggregate(
        ...
        Ok(ExecutorEnum::ResultProcessing(
            ResultProcessingExecutor::Aggregate(executor),
        ))
    }
    ...
    pub fn build_window(
        ...
        Ok(ExecutorEnum::ResultProcessing(
            ResultProcessingExecutor::Window(executor),
        ))
    }
    ...
    pub fn build_dedup(
        ...
        Ok(ExecutorEnum::ResultProcessing(
            ResultProcessingExecutor::Dedup(executor),
        ))
    }
}
