...
impl StatementType {
    pub fn from_bound(bound: &BoundStatement) -> Self {
        match bound {
            ...
            BoundStatement::FetchVertices(_) | BoundStatement::FetchEdges(_) => {
                StatementType::Fetch
            }
            BoundStatement::FindPath(_) => StatementType::FindPath,
            BoundStatement::Subgraph(_) => StatementType::Subgraph,
            BoundStatement::Pipe(_) => StatementType::Pipe,
            BoundStatement::Return(_) => StatementType::Return,
            BoundStatement::With(_) => StatementType::With,
            BoundStatement::Unwind(_) => StatementType::Unwind,
            BoundStatement::GroupBy(_) => StatementType::GroupBy,
            BoundStatement::SetOperation(_) => StatementType::SetOperation,
            BoundStatement::Filter(_) => StatementType::Filter,
            BoundStatement::Yield(_) => StatementType::Yield,
            BoundStatement::Collect(_) => StatementType::Collect,
            BoundStatement::AssignVariable(_) => StatementType::AssignVariable,
            BoundStatement::Assignment(_) => StatementType::Assignment,
            ...
            BoundStatement::Set(_) => StatementType::Set,
            BoundStatement::Remove(_) => StatementType::Remove,
            BoundStatement::Copy(_) => StatementType::Copy,
            ...
            BoundStatement::Show(_) | BoundStatement::ShowCreate(_) | BoundStatement::Desc(_) => {
                StatementType::Show
            }
            BoundStatement::ClearSpace(_) => StatementType::Space,
            BoundStatement::CreateUser(_)
            | BoundStatement::DropUser(_)
            | BoundStatement::AlterUser(_) => StatementType::User,
            BoundStatement::CreateFulltextIndex(_) => StatementType::Fulltext,
            BoundStatement::CreateVectorIndex(_) => StatementType::Vector,
            BoundStatement::Explain(_) => StatementType::Explain,
            BoundStatement::Profile(_) => StatementType::Profile,
            BoundStatement::Use(_) => StatementType::Use,
            BoundStatement::BeginTransaction(_)
            | BoundStatement::Commit(_)
            | BoundStatement::Rollback(_)
            | BoundStatement::Savepoint(_)
            | BoundStatement::ReleaseSavepoint(_) => StatementType::Transaction,
            BoundStatement::Other(_) => StatementType::Other,
        }
    }
}
...
impl fmt::Display for StatementType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            StatementType::Fetch => write!(f, "FETCH"),
            StatementType::FindPath => write!(f, "FIND PATH"),
            StatementType::Subgraph => write!(f, "SUBGRAPH"),
            StatementType::Pipe => write!(f, "PIPE"),
            StatementType::Return => write!(f, "RETURN"),
            StatementType::With => write!(f, "WITH"),
            StatementType::Unwind => write!(f, "UNWIND"),
            StatementType::GroupBy => write!(f, "GROUP BY"),
            StatementType::SetOperation => write!(f, "SET OPERATION"),
            StatementType::Filter => write!(f, "FILTER"),
            StatementType::Yield => write!(f, "YIELD"),
            StatementType::Collect => write!(f, "COLLECT"),
            StatementType::AssignVariable => write!(f, "ASSIGN VARIABLE"),
            StatementType::Assignment => write!(f, "ASSIGNMENT"),
            ...
            StatementType::Set => write!(f, "SET"),
            StatementType::Remove => write!(f, "REMOVE"),
            StatementType::Copy => write!(f, "COPY"),
            StatementType::Create => write!(f, "CREATE"),
            StatementType::Drop => write!(f, "DROP"),
            StatementType::Alter => write!(f, "ALTER"),
            StatementType::Show => write!(f, "SHOW"),
            StatementType::Space => write!(f, "SPACE"),
            StatementType::Use => write!(f, "USE"),
            StatementType::Explain => write!(f, "EXPLAIN"),
            StatementType::Profile => write!(f, "PROFILE"),
            StatementType::User => write!(f, "USER"),
            StatementType::Fulltext => write!(f, "FULLTEXT"),
            StatementType::Vector => write!(f, "VECTOR"),
            StatementType::Transaction => write!(f, "TRANSACTION"),
