...
fn parse_vector_index_config(
    ctx: &mut ParseContext,
) -> Result<VectorIndexConfig, crate::parser::ParseError> {
    ctx.expect_token(TokenKind::LParen)?;
    ...
    let mut quantization: Option<crate::parser::ast::vector::QuantizationKind> = None;
    let mut quantile: Option<f32> = None;
    let mut compression: Option<crate::parser::ast::vector::CompressionRatioKind> = None;
        ...
        match key.to_lowercase().as_str() {
            ...
            "compression" | "pq_compression" => {
                ...
                compression = Some(match c_str.to_lowercase().as_str() {
                    "x4" | "4" => crate::parser::ast::vector::CompressionRatioKind::X4,
                    "x8" | "8" => crate::parser::ast::vector::CompressionRatioKind::X8,
                    "x16" | "16" => crate::parser::ast::vector::CompressionRatioKind::X16,
                    "x32" | "32" => crate::parser::ast::vector::CompressionRatioKind::X32,
                    "x64" | "64" => crate::parser::ast::vector::CompressionRatioKind::X64,
                    _ => {
                        return Err(crate::parser::ParseError::new(
                            crate::parser::core::error::ParseErrorKind::SyntaxError,
                            format!(
...
fn parse_vector_query_expr(
    ctx: &mut ParseContext,
) -> Result<VectorQueryExpr, crate::parser::ParseError> {
    let span = ctx.current_span();
...
fn parse_vector_yield_clause(
    ctx: &mut ParseContext,
) -> Result<VectorYieldClause, crate::parser::ParseError> {
    let mut items = Vec::new();
...
mod tests {
    use crate::parser::ast::stmt::Stmt;
    use crate::parser::parsing::parser::Parser;
