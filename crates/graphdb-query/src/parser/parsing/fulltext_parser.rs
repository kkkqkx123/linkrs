...
pub fn parse_fulltext(ctx: &mut ParseContext) -> Result<Stmt, crate::parser::ParseError> {
...
fn parse_fulltext_query_expr(
    ctx: &mut ParseContext,
) -> Result<FulltextQueryExpr, crate::parser::ParseError> {
...
fn parse_yield_clause(
    ctx: &mut ParseContext,
) -> Result<FulltextYieldClause, crate::parser::ParseError> {
...
fn parse_lookup_fulltext(ctx: &mut ParseContext) -> Result<Stmt, crate::parser::ParseError> {
...
fn parse_match_fulltext(ctx: &mut ParseContext) -> Result<Stmt, crate::parser::ParseError> {
    ctx.consume_keyword("MATCH")?;
...
mod tests {
    ...
    fn test_parse_search_statement_where_and_order() {
        ...
        let search = match stmt {
            crate::parser::ast::stmt::Stmt::Search(stmt) => stmt,
    ...
    fn test_parse_search_statement_highlight() {
        ...
        let stmt = result.ast.stmt();
        match stmt {
            crate::parser::ast::stmt::Stmt::Search(search) => {
                let items = search
                    .yield_clause
                    .as_ref()
