...
pub(in crate::executor::streaming::plan::arena_builder) fn build_insert_vertices_spec(
...
pub(in crate::executor::streaming::plan::arena_builder) fn build_insert_edges_spec(
    node: &crate::planning::plan::core::nodes::data_modification::insert_nodes::InsertEdgesNode,
    exec_ctx: &ExecutionContext,
) -> Result<SinkSpec, PlanBuildError> {
...
pub(in crate::executor::streaming::plan::arena_builder) fn build_delete_edges_spec(
    node: &crate::planning::plan::core::nodes::data_modification::delete_nodes::DeleteEdgesNode,
    exec_ctx: &ExecutionContext,
) -> Result<SinkSpec, PlanBuildError> {
...
pub(in crate::executor::streaming::plan::arena_builder) fn build_pipe_delete_vertices_spec(
    node: &crate::planning::plan::core::nodes::data_modification::delete_nodes::PipeDeleteVerticesNode,
    exec_ctx: &ExecutionContext,
) -> Result<SinkSpec, PlanBuildError> {
...
pub(in crate::executor::streaming::plan::arena_builder) fn build_pipe_delete_edges_spec(
    node: &crate::planning::plan::core::nodes::data_modification::delete_nodes::PipeDeleteEdgesNode,
    exec_ctx: &ExecutionContext,
) -> Result<SinkSpec, PlanBuildError> {
    let edge_type = node.edge_type().unwrap_or("").to_string();
...
pub(in crate::executor::streaming::plan::arena_builder) fn build_update_spec(
    node: &crate::planning::plan::core::nodes::data_modification::update_nodes::UpdateNode,
    exec_ctx: &ExecutionContext,
) -> Result<SinkSpec, PlanBuildError> {
...
pub(in crate::executor::streaming::plan::arena_builder) fn build_update_vertices_spec(
    node: &crate::planning::plan::core::nodes::data_modification::update_nodes::UpdateVerticesNode,
    exec_ctx: &ExecutionContext,
) -> Result<SinkSpec, PlanBuildError> {
    let tag_name = node
        .updates()
...
pub(in crate::executor::streaming::plan::arena_builder) fn build_update_edges_spec(
    node: &crate::planning::plan::core::nodes::data_modification::update_nodes::UpdateEdgesNode,
    exec_ctx: &ExecutionContext,
) -> Result<SinkSpec, PlanBuildError> {
...
pub(in crate::executor::streaming::plan::arena_builder) fn build_copy_from_spec(
    node: &crate::planning::plan::core::nodes::data_modification::copy_nodes::CopyFromNode,
    exec_ctx: &ExecutionContext,
) -> Result<SinkSpec, PlanBuildError> {
...
pub(in crate::executor::streaming::plan::arena_builder) fn build_copy_to_spec(
    node: &crate::planning::plan::core::nodes::data_modification::copy_nodes::CopyToNode,
    exec_ctx: &ExecutionContext,
) -> Result<SinkSpec, PlanBuildError> {
    let target = match node.target() {
        crate::planning::plan::core::nodes::data_modification::copy_nodes::CopyTarget::Vertex(
...
fn space_manage_to_command(
    node: &crate::planning::plan::core::nodes::management::manage_node_enums::SpaceManageNode,
) -> SpaceManageCommand {
...
fn tag_manage_to_command(
    node: &crate::planning::plan::core::nodes::management::manage_node_enums::TagManageNode,
) -> TagManageCommand {
    use crate::executor::streaming::operators::spec::TagManageCommand;
    use crate::planning::plan::core::nodes::management::manage_node_enums::TagManageNode::*;
    match node {
        Create(n) => {
            let info = n.info();
...
fn edge_manage_to_command(
    node: &crate::planning::plan::core::nodes::management::manage_node_enums::EdgeManageNode,
) -> EdgeManageCommand {
    use crate::executor::streaming::operators::spec::EdgeManageCommand;
    use crate::planning::plan::core::nodes::management::manage_node_enums::EdgeManageNode::*;
    match node {
        Create(n) => {
            let info = n.info();
...
fn index_manage_to_command(
    node: &crate::planning::plan::core::nodes::management::manage_node_enums::IndexManageNode,
) -> IndexManageCommand {
    use crate::executor::streaming::operators::spec::IndexManageCommand;
    use crate::planning::plan::core::nodes::management::manage_node_enums::IndexManageNode::*;
    match node {
        CreateTagIndex(n) => {
            let info = n.info();
...
fn user_manage_to_command(
    node: &crate::planning::plan::core::nodes::management::manage_node_enums::UserManageNode,
) -> UserManageCommand {
...
pub(in crate::executor::streaming::plan::arena_builder) fn build_space_manage_spec(
    node: &crate::planning::plan::core::nodes::management::manage_node_enums::SpaceManageNode,
...
pub(in crate::executor::streaming::plan::arena_builder) fn build_tag_manage_spec(
    node: &crate::planning::plan::core::nodes::management::manage_node_enums::TagManageNode,
    exec_ctx: &ExecutionContext,
) -> Result<DdlSpec, PlanBuildError> {
...
pub(in crate::executor::streaming::plan::arena_builder) fn build_edge_manage_spec(
    node: &crate::planning::plan::core::nodes::management::manage_node_enums::EdgeManageNode,
    exec_ctx: &ExecutionContext,
) -> Result<DdlSpec, PlanBuildError> {
...
pub(in crate::executor::streaming::plan::arena_builder) fn build_index_manage_spec(
    node: &crate::planning::plan::core::nodes::management::manage_node_enums::IndexManageNode,
    exec_ctx: &ExecutionContext,
) -> Result<DdlSpec, PlanBuildError> {
...
pub(in crate::executor::streaming::plan::arena_builder) fn build_delete_index_spec(
    node: &crate::planning::plan::core::nodes::data_modification::delete_nodes::DeleteIndexNode,
    _exec_ctx: &ExecutionContext,
) -> Result<DdlSpec, PlanBuildError> {
...
pub(in crate::executor::streaming::plan::arena_builder) fn build_user_manage_spec(
    node: &crate::planning::plan::core::nodes::management::manage_node_enums::UserManageNode,
    _exec_ctx: &ExecutionContext,
) -> Result<DdlSpec, PlanBuildError> {
...
fn fulltext_manage_to_command(
    node: &crate::planning::plan::core::nodes::management::manage_node_enums::FulltextManageNode,
...
pub(in crate::executor::streaming::plan::arena_builder) fn build_fulltext_manage_spec(
    node: &crate::planning::plan::core::nodes::management::manage_node_enums::FulltextManageNode,
    exec_ctx: &ExecutionContext,
...
pub(in crate::executor::streaming::plan::arena_builder) fn build_fulltext_search_spec(
    node: &crate::planning::plan::core::nodes::search::fulltext::data_access::FulltextSearchNode,
    exec_ctx: &ExecutionContext,
) -> Result<FulltextSpec, PlanBuildError> {
...
pub(in crate::executor::streaming::plan::arena_builder) fn build_fulltext_lookup_spec(
    node: &crate::planning::plan::core::nodes::search::fulltext::data_access::FulltextLookupNode,
    exec_ctx: &ExecutionContext,
) -> Result<FulltextSpec, PlanBuildError> {
...
pub(in crate::executor::streaming::plan::arena_builder) fn build_match_fulltext_spec(
    node: &crate::planning::plan::core::nodes::search::fulltext::data_access::MatchFulltextNode,
    exec_ctx: &ExecutionContext,
) -> Result<FulltextSpec, PlanBuildError> {
...
fn vector_manage_to_command(
    node: &crate::planning::plan::core::nodes::management::manage_node_enums::VectorManageNode,
) -> VectorManageCommand {
...
pub(in crate::executor::streaming::plan::arena_builder) fn build_vector_manage_spec(
    node: &crate::planning::plan::core::nodes::management::manage_node_enums::VectorManageNode,
    exec_ctx: &ExecutionContext,
...
#[cfg(feature = "vector")]
pub(in crate::executor::streaming::plan::arena_builder) fn build_vector_lookup_spec(
    node: &crate::planning::plan::core::nodes::search::vector::data_access::VectorLookupNode,
    exec_ctx: &ExecutionContext,
) -> Result<VectorSpec, PlanBuildError> {
...
#[cfg(feature = "vector")]
pub(in crate::executor::streaming::plan::arena_builder) fn build_vector_match_spec(
