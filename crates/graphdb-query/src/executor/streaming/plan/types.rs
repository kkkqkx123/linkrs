    ...
    fn fingerprint_is_stable_within_version() {
        let ops = vec![PhysicalOperatorSpec {
            ...
            spec: OperatorKindSpec::Source(
                crate::executor::streaming::operators::spec::SourceSpec::Start,
            ),
            input_contract: InputContract::NoInput,
            input_layout: None,
            output_layout: crate::executor::streaming::slot::SlotLayout::new(vec![]),
        ...
        let ops2 = vec![
            ...
            PhysicalOperatorSpec {
                ...
                spec: OperatorKindSpec::Blocking(
                    crate::executor::streaming::operators::spec::BlockingSpec::Distinct,
                ),
                input_contract: InputContract::NoInput,
                input_layout: None,
                output_layout: crate::executor::streaming::slot::SlotLayout::new(vec![]),
