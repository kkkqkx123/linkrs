...
impl DdlState {
    pub fn from_spec(spec: &super::spec::DdlSpec) -> Self {
        match spec {
            ...
            super::spec::DdlSpec::ShowAttachedDatabases { .. } => DdlState::ShowAttachedDatabases,
            super::spec::DdlSpec::ShowExtensions { .. } => DdlState::ShowExtensions,
            super::spec::DdlSpec::LoadFrom { .. } => DdlState::LoadFrom,
            super::spec::DdlSpec::InQueryCall { .. } => DdlState::InQueryCall,
