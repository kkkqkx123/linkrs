...
impl DefaultExpressionContext {
    ...
    pub fn from_execution_context(ctx: &crate::executor::base::ExecutionContext) -> Self {
        Self {
    ...
    pub fn sync_to_execution_context(self, ctx: &crate::executor::base::ExecutionContext) {
    ...
    for DefaultExpressionContext
{
    ...
    fn get_session_variable(
        &self,
        name: &str,
    ) -> Result<Value, crate::executor::expression::ExpressionError> {
        self.session_variables
            .as_ref()
            .and_then(|vars| vars.get(name).cloned())
            .ok_or_else(|| {
                crate::executor::expression::ExpressionError::type_error(format!(
    ...
    fn get_function(
        &self,
        name: &str,
    ) -> Option<crate::executor::expression::functions::OwnedFunctionRef> {
