...
mod cardinality_estimation {
    ...
    fn test_aggregate_cardinality() {
        TestScenario::new()
            ...
            .exec_ddl("CREATE TAG person(id INT, city STRING)")
            .assert_success()
...
mod plan_comparison {
    ...
    fn test_sort_merge_vs_hash_aggregate() {
        TestScenario::new()
            ...
            .exec_ddl("CREATE TAG person(id INT, city STRING, age INT)")
            .assert_success()
...
mod selectivity_estimation {
    ...
    fn test_selectivity_range_predicate() {
        TestScenario::new()
            ...
            .exec_ddl("CREATE TAG person(id INT, age INT, salary INT)")
            .assert_success()
    ...
    fn test_selectivity_inequality() {
        TestScenario::new()
            ...
            .exec_ddl("CREATE TAG person(id INT, status STRING)")
            .assert_success()
    ...
    fn test_selectivity_compound_predicates() {
        TestScenario::new()
            ...
            .exec_ddl("CREATE TAG person(id INT, age INT, city STRING, salary INT)")
            .assert_success()
...
mod index_selection_scenarios {
    ...
    fn test_index_selection_single_column_index() {
        TestScenario::new()
            ...
            .exec_ddl("CREATE TAG employee(id INT, emp_id INT, name STRING, age INT)")
    ...
    fn test_index_selection_composite_index() {
        TestScenario::new()
            ...
            .exec_ddl("CREATE TAG product(id INT, category STRING, price INT, availability INT)")
    ...
    fn test_no_index_full_scan_fallback() {
        TestScenario::new()
            ...
            .exec_ddl("CREATE TAG customer(id INT, name STRING, city STRING)")
            .assert_success()
    ...
    fn test_index_selection_with_multiple_conditions() {
        TestScenario::new()
            ...
            .exec_ddl("CREATE TAG account(id INT, user_id INT, status STRING, balance DOUBLE)")
...
mod traversal_optimization {
    ...
    fn test_traversal_with_index_on_start() {
        TestScenario::new()
            ...
            .exec_ddl("CREATE TAG user(id INT, user_id INT)")
...
mod complex_scenarios {
    ...
    fn test_complex_query_with_multiple_filters() {
        TestScenario::new()
            ...
            .exec_ddl("CREATE TAG person(id INT, age INT, salary INT, city STRING)")
            .exec_ddl("CREATE TAG company(id INT, size INT)")
            .exec_ddl("CREATE EDGE works_at()")
            .assert_success()
    ...
    fn test_query_with_join_and_aggregation() {
        TestScenario::new()
            ...
            .exec_ddl("CREATE TAG person(id INT, name STRING, gender STRING)")
            .exec_ddl("CREATE TAG department(id INT, dept_name STRING)")
