...
mod subquery_unnesting {
    ...
    fn test_subquery_with_aggregation() {
        TestScenario::new()
            ...
            .exec_ddl("CREATE TAG employee(id INT, salary INT, department STRING)")
            .assert_success()
...
mod materialization_decisions {
    ...
    fn test_materialization_memory_constraint() {
        TestScenario::new()
            ...
            .exec_ddl("CREATE TAG person(id INT, name STRING, data STRING)")
            .exec_ddl("CREATE TAG company(id INT, name STRING)")
            .exec_ddl("CREATE EDGE works_at()")
            .assert_success()
...
mod expression_precomputation {
    ...
    fn test_deterministic_expression_precomputation() {
        TestScenario::new()
            ...
            .exec_ddl("CREATE TAG product(id INT, name STRING, price INT)")
            .assert_success()
    ...
    fn test_complex_expression_precomputation() {
        TestScenario::new()
            ...
            .exec_ddl("CREATE TAG employee(id INT, salary INT, bonus_rate DOUBLE, years INT)")
            .assert_success()
...
mod topn_optimization {
    ...
    fn test_topn_with_multiple_columns() {
        TestScenario::new()
            ...
            .exec_ddl("CREATE TAG employee(id INT, department STRING, salary INT, hire_date STRING)")
            .assert_success()
...
mod aggregate_strategy_selection {
    ...
    fn test_hash_aggregate() {
        TestScenario::new()
            ...
            .exec_ddl("CREATE TAG transaction(id INT, category STRING, amount INT)")
            .assert_success()
    ...
    fn test_sort_aggregate() {
        TestScenario::new()
            ...
            .exec_ddl("CREATE TAG sales(id INT, region STRING, amount INT)")
            .assert_success()
    ...
    fn test_multiple_aggregates() {
        TestScenario::new()
            .expect("Failed to create test scenario")
            .setup_space("test_multi_agg")
            .exec_ddl("CREATE TAG payment(id INT, category STRING, amount INT)")
            .assert_success()
