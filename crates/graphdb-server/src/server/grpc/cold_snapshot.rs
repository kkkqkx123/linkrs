...
use crate::server::grpc::proto::coldsnapshot::{
...
pub struct ColdSnapshotClient {
    inner: crate::server::grpc::proto::coldsnapshot::cold_snapshot_service_client::ColdSnapshotServiceClient<tonic::transport::Channel>,
}
...
impl ColdSnapshotClient {
    ...
    pub fn with_channel(channel: tonic::transport::Channel) -> Self {
        Self {
            inner: crate::server::grpc::proto::coldsnapshot::cold_snapshot_service_client::ColdSnapshotServiceClient::new(channel),
        }
    }
...
mod tests {
    use super::*;
    use crate::server::grpc::proto::coldsnapshot::cold_snapshot_service_server::ColdSnapshotServiceServer;
