...
pub(crate) fn serving_error(message: String) -> StorageError {
...
#[derive(Debug, Clone, Copy, Default)]
pub(crate) struct ServingColumns {
...
pub(crate) fn parse_header(bytes: &[u8]) -> StorageResult<(usize, usize, u64, ServingColumns)> {
