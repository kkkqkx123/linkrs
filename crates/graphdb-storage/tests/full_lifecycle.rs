...
fn test_space_isolation() {
    ...
    // Create Person tag in both spaces (id-leading schema matching
    // common::create_person_vertex).
    common::create_person_tag(&mut storage, "alpha");
    common::create_person_tag(&mut storage, "beta");
