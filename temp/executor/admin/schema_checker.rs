...
use crate::storage::{ChangeDetails, StorageReader};
...
impl SchemaCompatibilityChecker {
    ...
    pub fn vertex_compatibility(
        ...
        report.affected_data_count = reader
...
mod tests {
    ...
    fn test_property_removal_is_breaking() {
        ...
        let report = checker
            .check_alter_vertex_compatibility("test_space", "User", &[change])
            .unwrap();
    ...
    fn test_edge_compatibility_static_method() {
        ...
        let report =
            SchemaCompatibilityChecker::edge_compatibility(&mock, "test_space", "Knows", &[change])
                .unwrap();
